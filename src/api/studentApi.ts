...
export default {
    getList: (params: StudentPageParams) =>
        request.get<Page.Resp<Student>>("/student/mng", params),
    add: (data: StudentAdd) => request.post("/student/mng", data),
    update: (data: StudentUpdate) => request.put("/student/mng", data),
    remove: (ids: string[]) => request.delete("/student/mng", { ids: ids }),
